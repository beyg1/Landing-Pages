...
export default function Services() {
  return (
    <Section id="services" width="full" className="flex items-center bg-white/60 dark:bg-white/5">
      <div className="w-full">
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="font-(--font-display) text-3xl tracking-tight md:text-4xl text-foreground">What we do best</h2>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((s, i) => (
              ...
              >
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-[color-mix(in_oklab,var(--accent)_18%,transparent)] text-foreground">
